...
function main(req, res) {
  (async () => {
    ...
    await page.screenshot({ path: "output2.png" },{delay:100});
    console.log(data2);
    ...
    await page.screenshot({ path: "output3.png" },{delay:100});
    console.log(data3);
    ...
    await page.screenshot({ path: "output4.png" },{delay:100});
    console.log(data4);
...
// covid vaccination percentage as per country and pupulation of all country
  ...
  //       };
  //     });
  //     await page.screenshot({ path: "output7.png" },{delay:100});
  //     console.log(data7);
   })();
}
main();
